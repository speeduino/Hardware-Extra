...
void loop() 
{
  ...
  map1_adc = analogRead(pinMAP1);
  map1 = fastMap10BitX8(map1_adc, MPX4250_min, MPX4250_max);

  map2_adc = analogRead(pinMAP2);
  map2_adc = analogRead(pinMAP2);
  map2 = fastMap10BitX8(map2_adc, MPX4250_min, MPX4250_max);

  map3_adc = analogRead(pinMAP3);
  map3_adc = analogRead(pinMAP3);
  map3 = fastMap10BitX8(map3_adc, MPX4250_min, MPX4250_max);

  map4_adc = analogRead(pinMAP4);
  map4_adc = analogRead(pinMAP4);
  map4 = fastMap10BitX8(map4_adc, MPX4250_min, MPX4250_max);
